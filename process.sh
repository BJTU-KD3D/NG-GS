...
python train.py -s "/home/hy/COB-GS-main/data_nvme/nerf_llff_data/flower" -m "output/flower"  --images "images_4"
python train.py -s "/home/hy/COB-GS-main/data_nvme/nerf_llff_data/horns" -m "/home/hy/cob/output/horns_center" --eval --start_checkpoint "/home/hy/cob/output/horns_center/chkpnt30000.pth" --include_mask --finetune_mask --text "horns_center" --images "images_4" --N4views 14 --mask_signals_threshold 0.8 --path_masks "/home/hy/cob/output/horns_center/mask/horns_center"
python render_segmentation.py --model_path /home/hy/cob/output/horns_center --text "horns_center" --path_masks "/home/hy/cob/output/horns_center/mask/horns_center"
python eval_NVOS.py horns_center


python train.py -s "/home/hy/COB-GS-main/data_nvme/nerf_llff_data/fern" -m "output/fern" --eval -r 4
python train.py -s "/home/hy/COB-GS-main/data_nvme/nerf_llff_data/fern" -m "output/fern" --eval --start_checkpoint "/home/hy/COB-GS-main/output/fern/chkpnt30000.pth" --include_mask --finetune_mask --text "fern" -r 4 --N4views 22 --mask_signals_threshold 0.5
python render.py -m "/home/hy/COB-GS-main/output/fern" --include_mask --finetune_mask --skip_train --text "fern" -r 4 --N4views 22 -w
python eval_NVOS.py fern


python train.py -s "/home/hy/COB-GS-mainm/data_nvme/nerf_llff_data/horns" -m "output/horns_left" --eval -r 4
python train.py -s "/home/hy/COB-GS-mainm/data_nvme/nerf_llff_data/horns" -m "output/horns_left" --start_checkpoint "/home/hy/COB-GS-mainm/output/horns_left/chkpnt30000.pth" --include_mask --finetune_mask --text "horns_left" -r 4 --N4views 22 --mask_signals_threshold 0.5
python render.py -m "/home/hy/COB-GS-mainm/output/horns_left" --include_mask --finetune_mask --skip_train --text "horns_left" -r 4 --N4views 22 -w
python eval_NVOS.py horns_left